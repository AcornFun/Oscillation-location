...
dz = 'E:\WeChat Files\wxid_4p251ezmrzxe22\FileStorage\File\2025-04\DTL FO_Location\sample_data\'; % input original data path
...
for j = 1:numberCandidate
    ...
    % 确保输出目录存在
    outputDir = fullfile('E:\WeChat Files\wxid_4p251ezmrzxe22\FileStorage\File\2025-04\DTL FO_Location\MoreSamples\global_output\');
    num2str(label);
